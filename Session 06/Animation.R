...
b1 <- read.bitmap("C:/Users/Jakob/Documents/EAGLE M.Sc/1st term/Introduction to Programming and Geostatistics/Playground/Session 06/eagle_web.png")
# b2 <- read.bitmap("~/eagle_EO.png")
b2 <- read.bitmap("C:/Users/Jakob/Documents/EAGLE M.Sc/1st term/Introduction to Programming and Geostatistics/Playground/Session 06/eo.png")
...
save_animation(animate(eagle_eo_anim, fps=20, nframes=50, width=2800, height=400), "C:/Users/Jakob/Documents/EAGLE M.Sc/1st term/Introduction to Programming and Geostatistics/Playground/Session 06/eagle_eo.gif")
